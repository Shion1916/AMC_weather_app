...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFB69F9B),
      // App bar at the top
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0,
        backgroundColor: Color(0xFF383533),
      ),
            ...
            Row(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text('Search',style: const TextStyle(
                    color: Colors.white,
                    fontSize: 16,
                  ),),
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xFFF0E1CD), Color(0xFFFFFFFF)],
